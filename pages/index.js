...
export default function FeriaCheck() {
  ...
  const handleRegister = () => {
    ...
    setAccounts({ ...accounts, [usernameLower]: { password: registerPassword, vendorId: newId } });
  ...
  const handleSaveProfile = () => {
    ...
    setVendors(vendors.map(v => (v.id === currentVendor.id ? updatedVendor : v)));
  ...
  const handleChangePassword = () => {
    ...
    setAccounts({ ...accounts, [currentVendor.username]: { ...accounts[currentVendor.username], password: newPassword } });
    setPasswordError('');
    setOldPassword('');
    setNewPassword('');
  ...
  const togglePresence = () => {
    ...
    setVendors(vendors.map(v => (v.id === currentVendor.id ? updated : v)));
  ...
  const handleAdminChangePassword = () => {
    ...
    setAccounts({ ...accounts, [currentAdmin]: { ...accounts[currentAdmin], password: adminNewPassword } });
    setAdminPasswordError('');
    setAdminOldPassword('');
    setAdminNewPassword('');
  ...
  const handleAdminSaveVendor = () => {
    ...
    setVendors(vendors.map(v => (v.id === adminEditingVendor.id ? updatedVendor : v)));
